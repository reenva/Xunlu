<?php get_header(); ?>
    <div id="primary">
        <div class="breadcrumb-navigation">
            ...
            <?php the_post(); ?>
            <span class="breadcrumb-arrow"></span><?php if($category=get_the_category($post->ID)) echo (get_category_parents($category[0]->term_id, TRUE, '<span class="breadcrumb-arrow"></span>')); ?><a href="<?php the_permalink(); ?>"
